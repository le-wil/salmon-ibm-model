...
if(__name__=='__main__'):
    ...
    output_file = pset.ParticleFile(name="output/FADPrey%s_no%d_npart%d_nfad%d_T%.2f_F%.2f_P%.2f_I%.2f_p%.1f_Pa%.1f.zarr"%(ff,seed,npart,nfad,float(sys.argv[4]),float(sys.argv[5]),float(sys.argv[6]),float(sys.argv[7]),float(sys.argv[8]),float(sys.argv[9])),
